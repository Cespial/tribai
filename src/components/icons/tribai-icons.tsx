 ...
 * 24x24 viewBox, strokeWidth 1.5, currentColor + var(--tribai-gold).
...
export function TribaiIconET({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden="true">
      ...
      <circle cx="12" cy="7" r="1.2" fill="var(--tribai-gold)"/>
      <circle cx="12" cy="11.5" r="1" fill="currentColor" opacity="0.5"/>
      <circle cx="12" cy="16" r="1" fill="currentColor" opacity="0.5"/>
      <line x1="12" y1="8.2" x2="12" y2="10.5" stroke="var(--tribai-gold)" strokeWidth="0.8" opacity="0.6"/>
...
export function TribaiIconCalculator({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden="true">
      ...
      <circle cx="12" cy="8" r="0.8" fill="var(--tribai-gold)"/>
      ...
      <rect x="11" y="17" width="2" height="1.5" rx="0.4" fill="var(--tribai-gold)"/>
...
export function TribaiIconAI({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden="true">
      ...
      <circle cx="12" cy="9" r="1.3" fill="var(--tribai-gold)"/>
...
export function TribaiIconCalendar({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden="true">
      ...
      <path d="M12 13l2.5 4h-5z" fill="var(--tribai-gold)" opacity="0.8"/>
      <circle cx="12" cy="13.5" r="0.8" fill="var(--tribai-gold)"/>
    </svg>
  );
}
...
export function TribaiIconBalance({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden="true">
      ...
      <circle cx="12" cy="5" r="1.5" fill="var(--tribai-gold)"/>
...
export function TribaiIconTarget({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden="true">
      ...
      <path d="M12 8l3 6h-6z" fill="var(--tribai-gold)" opacity="0.7"/>
      <circle cx="12" cy="10.5" r="0.8" fill="var(--tribai-gold)"/>
    </svg>
  );
}
...
export function TribaiIconComparador({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden="true">
      ...
      <path d="M16 13l2 3h-4z" fill="var(--tribai-gold)" opacity="0.8"/>
    </svg>
  );
}
...
export function TribaiIconGuias({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden="true">
      ...
      <circle cx="12" cy="16" r="1.3" fill="var(--tribai-gold)"/>
...
export function TribaiIconWorkspace({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden="true">
      ...
      <circle cx="12" cy="8" r="1.2" fill="var(--tribai-gold)"/>
...
export function TribaiIconClock({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden="true">
      <circle cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="1.5"/>
      <circle cx="12" cy="12" r="1.5" fill="var(--tribai-gold)"/>
...
export function TribaiIconCertification({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden="true">
      ...
      <path d="M12 13l3.5 5.5h-7z" stroke="var(--tribai-gold)" strokeWidth="1.2" strokeLinejoin="round" fill="none"/>
      <circle cx="12" cy="15.5" r="1" fill="var(--tribai-gold)"/>
    </svg>
  );
}
...
export function TribaiIconBrain({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden="true">
      ...
      <circle cx="12" cy="8" r="1.3" fill="var(--tribai-gold)"/>
      <circle cx="9" cy="12" r="1" fill="currentColor" opacity="0.5"/>
      <circle cx="15" cy="12" r="1" fill="currentColor" opacity="0.5"/>
      <line x1="12" y1="9.3" x2="9.5" y2="11.2" stroke="var(--tribai-gold)" strokeWidth="0.8" opacity="0.5"/>
      <line x1="12" y1="9.3" x2="14.5" y2="11.2" stroke="var(--tribai-gold)" strokeWidth="0.8" opacity="0.5"/>
