...
ORG_ID = "com.superapp-tributaria"
...
w(f'\t\t\t\tINFOPLIST_KEY_CFBundleDisplayName = "SuperApp Tributaria";')
...
w(f'\t\t\t\tPRODUCT_BUNDLE_IDENTIFIER = "{ORG_ID}.SuperAppTributaria";')
...
w("\t\t\t\tGENERATE_INFOPLIST_FILE = YES;")
w("\t\t\t\tMARKETING_VERSION = 1.0.0;")
w(f'\t\t\t\tPRODUCT_BUNDLE_IDENTIFIER = "{ORG_ID}.SuperAppTributariaTests";')
w(f'\t\t\t\tPRODUCT_NAME = "$(TARGET_NAME)";')
...
w("\t\t\t\tGENERATE_INFOPLIST_FILE = YES;")
w("\t\t\t\tMARKETING_VERSION = 1.0.0;")
w(f'\t\t\t\tPRODUCT_BUNDLE_IDENTIFIER = "{ORG_ID}.SuperAppTributariaUITests";')
w(f'\t\t\t\tPRODUCT_NAME = "$(TARGET_NAME)";')
w('\t\t\t\tSWIFT_EMIT_LOC_STRINGS = NO;')
w('\t\t\t\tTARGETED_DEVICE_FAMILY = "1,2";')
